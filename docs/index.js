...
function formatName(e) {
  ...
  return t.length === 2 ? `${t[1]} ${t[0]}` : e;
}
function contestName(e) {
...
function awardSummary(t) {
  const n = contestName(t.source_csv);
  return t.group_name
...
function p() {
  ...
  (0, l.useEffect)(() => {
    fetch(`./awards.json`)
      .then((e) => {
        if (!e.ok) throw Error(`Failed to load awards data`);
        return e.json();
      })
      .then((e) => {
        r(e.people || []);
      ...
      .catch((e) => {
        u(e.message || `Unable to load awards data.`);
      });
  }, []);
  let d = (0, l.useMemo)(
  ...
  function p(t) {
    ...
    let r = e.trim();
    if (!r) {
      (u(`Enter a name to search.`), a(null));
      return;
    }
    (s(!0), u(``));
      ...
      children: [
        (0, f.jsxs)(`header`, {
          ...
          children: [
            (0, f.jsx)(`p`, {
              className: `eyebrow`,
              children: `Awards Database`,
            }),
            (0, f.jsx)(`h1`, { children: `Name Search` }),
            (0, f.jsx)(`p`, {
              className: `subtle`,
              children: `Find matching students and browse all recorded awards.`,
            }),
          ],
        }),
        (0, f.jsxs)(`form`, {
          ...
          children: [
            ...
            (0, f.jsx)(`input`, {
              ...
              placeholder: `Search by substring, e.g. chen`,
              autoComplete: `off`,
            }),
            (0, f.jsx)(`button`, {
              type: `submit`,
        ...
        c && (0, f.jsx)(`p`, { className: `error`, children: c }),
        !c &&
          n.length === 0 &&
          (0, f.jsx)(`p`, {
            className: `meta`,
            children: `Loading awards data...`,
          }),
        i &&
          (0, f.jsxs)(`section`, {
            className: `results`,
            children: [
              (0, f.jsxs)(`div`, {
                ...
                children: [
                  (0, f.jsxs)(`p`, {
                    children: [
                      (0, f.jsx)(`strong`, { children: i.count }),
                      ` match(es) for `,
                      (0, f.jsx)(`strong`, { children: i.query }),
                    ],
                  }),
                  (0, f.jsxs)(`p`, {
                    className: `meta`,
                    children: [d, ` total award record(s)`],
                  }),
                ],
              }),
              i.count === 0
                                    ...
                                    children: [
                                      ...
                                      (0, f.jsxs)(`div`, {
                                        children: [
                                          ...
                                          (0, f.jsx)(`span`, {
                                            children: t.source_csv,
                                          }),
                                        ],
                                      }),
                                    ],
                                  },
                                  `${e.id}-${t.year}-${t.source_csv}-${t.group_name}-${n}`,
                                ),
                              ),
                            }),
                          ],
...
(0, u.createRoot)(document.getElementById(`root`)).render(
  (0, f.jsx)(l.StrictMode, { children: (0, f.jsx)(p, {}) }),
);
